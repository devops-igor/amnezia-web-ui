...
@pytest.mark.e2e
@pytest.mark.asyncio
async def test_server_list_loads(authenticated_page: Page, base_url: str) -> None:
...
@pytest.mark.e2e
@pytest.mark.asyncio
async def test_server_detail_page(authenticated_page: Page, base_url: str) -> None:
...
@pytest.mark.e2e
@pytest.mark.asyncio
async def test_server_check(authenticated_page: Page, base_url: str, csrf_token: str) -> None:
    ...
    server_id = servers[0]["id"]
    check_result = await api_post(page, f"/api/servers/{server_id}/check", {}, csrf_token)
...
@pytest.mark.e2e
@pytest.mark.asyncio
async def test_server_install(authenticated_page: Page, base_url: str, csrf_token: str) -> None:
    ...
    server_id = servers[0]["id"]
    install_result = await api_post(page, f"/api/servers/{server_id}/install", {}, csrf_token)
...
@pytest.mark.e2e
@pytest.mark.asyncio
async def test_server_stats(authenticated_page: Page, base_url: str, csrf_token: str) -> None:
    ...
    server_id = servers[0]["id"]
    stats_result = await api_post(page, f"/api/servers/{server_id}/stats", {}, csrf_token)
...
@pytest.mark.e2e
@pytest.mark.asyncio
async def test_server_add_form(authenticated_page: Page, base_url: str) -> None:
...
@pytest.mark.e2e
@pytest.mark.asyncio
async def test_server_reboot(authenticated_page: Page, base_url: str, csrf_token: str) -> None:
    ...
    server_id = servers[0]["id"]
    reboot_result = await api_post(page, f"/api/servers/{server_id}/reboot", {}, csrf_token)
