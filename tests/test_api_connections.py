...
class TestApiMyAddConnection:
    ...
    def test_duplicate_connection_name_returns_json_error(
        self, mock_get_protocol_manager, mock_get_ssh, mock_get_current_user, mock_save_data, mock_load_data
    ):
    ...
    @patch('app.save_data')
    @patch('app.get_current_user')
    def test_duplicate_connection_error_message_format(self, mock_get_current_user, mock_save_data, mock_load_data):
